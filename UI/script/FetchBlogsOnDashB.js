var blogsData = JSON.parse(localStorage.getItem("blogs")) || [];
...
blogsData.forEach(function (blog) {
  ...
  image.src = blog.image; // Assuming each blog object has an 'image' property
  ...
  titleParagraph.textContent = blog.blogTitle;
